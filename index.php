...
<body class="login">
	...
	<div class="content">
		...
		<form class="form-vertical login-form" action="php/login.php" method="post">
			...
			<div class="forget-password">
				...
				<p>
					No te preocupes, <a href="javascript:;"  id="forget-password">Haz click aquí</a>
			...
			<div class="create-account">
				<p>
					...
					<a href="javascript:;" id="register-btn" >Crea tu cuenta</a>
				</p>
			</div>
		</form>
		<!-- END LOGIN FORM -->        
		<!-- BEGIN FORGOT PASSWORD FORM -->
		<form class="form-vertical register-form" action="php/registro.php" method="post">
			<h3 >Registro | GutLeben</h3>
			<p>Ingrese sus datos personales:</p>
			
                        <div class="control-group">
				<label class="control-label visible-ie8 visible-ie9">Apellidos y Nombres</label>
				<div class="controls">
					<div class="input-icon left">
						<i class="icon-font"></i>
						<input class="m-wrap placeholder-no-fix" type="text" placeholder="Apellidos" name="fullname"/>
					</div>
				</div>
			</div>
			...
			<div class="control-group">
				...
				<div class="controls">
					<div class="input-icon left">
						<i class="icon-ok"></i>
						<input class="m-wrap placeholder-no-fix" type="password" autocomplete="off" placeholder="Repita su contraseña" name="confirm_password"/>
					</div>
				</div>
			</div>
			<div class="control-group">
				<div class="controls">
					<label class="checkbox">
					<input type="checkbox" name="tnc"/> Acepto las <a href="#">Condiciones del servicio</a> y la <a href="#">Política de privacidad </a>
					</label>  
	...
	<!-- BEGIN COPYRIGHT -->
	<div class="copyright">
		2015 &copy; <a href="https://www.facebook.com/ValoresHumanosPeru/">GutLeben</a> Login
	</div>
	<!-- END COPYRIGHT -->
